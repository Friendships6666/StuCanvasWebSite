 ...
 * @returns {Uint8Array}
 */
export function decrypt_file(encrypted_data, password) {
 ...
 * @returns {Uint8Array}
 */
export function encrypt_file(file_data, password) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wasm_enc_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
